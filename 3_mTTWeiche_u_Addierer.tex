...
Passend dem Signalverlauf sitzt am Beginn der Schaltung (Abb. \ref{fig:abb3.1}) die erste Regelung über Potentiometer. Anschließend kommt man zu der Addier-Schaltung welche das Stereo-Signal in ein Mono-Signal wandelt und dadurch Stereo-Effekte wie zB. Balance am \enquote{Mono-Bass} entfernt.\\
...
Nach Addieren des Stereo-Signals zu einem Mono-Signal kommt dieses zum Aktiven-Tiefpass-Filter. Bevor das gefilterte Signal weiter zum Verstärker geht wird nochmals die Möglichkeit geboten um die Amplitude des Signals anzupassen.
\begin{figure} [h]
	\centering
...
Die Grundschaltung eines Butterworth-Filter 2. Ordnung ist für verschieden Grenzfrequenzen gleich. Es besteht hauptsächlich aus einem OPV, drei Widerständen und zwei Kondensatoren. Deren Anordnung ist ausschlaggebend für das Filter (Abb. \ref{fig:abb3.2}).
\begin{figure} [h]
	\centering
