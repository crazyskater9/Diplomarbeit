...
Ebenfalls einmal mit und einmal ohne Wolle im Gehäuse.
\begin{figure} [H]
	\centering
	...
	\label{fig:5.3.4.2}
\end{figure}
Dieser Lautsprecher weißt eine einigermaßen vertretbare Welligkeit im Mittel und Hochton-Bereich auf.
Beim Niederton-Bereich jedoch ist er weniger gut dabei.
Der Mono-Subwoofer müsste bis einige 100-Hertz spielen um diese Schwäche auszumerzen.
Ein Subwoofer sollte jedoch nicht über 150 bis 200 Hz kommen, da Frequenzen unterhalb nicht lokalisiert werden können.
...
Für einen Tieftöner ist das nicht so schlimm, da die \enquote{Dustcap} in diesem Fall rein für den Schutz von Staub ist.
...
\\ \\
Nach feststellen des Schadens wurde der Frequenzgang des TT1 erneut überprüft und er wies keine wesentlichen Veränderungen auf, was zu dem Schluss führte das er normal weiter gemessen wurde.\\
Als nächster Schritt werden die Tieftöner unter variierendem Volumina gemessen.
Dafür wird, wie zuvor erwähnt, hauptsächlich Ytong und Styropor verwendet.
Styropor gilt auch als halbwegs schalltotes Material.
