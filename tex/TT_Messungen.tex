...
Die zwei Subwoofer-Chassis wurden einmal mit und einmal ohne Polyesterwatte in der Box gemessen.
\begin{figure} [H]
	\centering
	...
	\caption{Subwoofer-Messung ohne Polyersterwatte\\ \enquote{Renkforce} (oben) und \enquote{Visaton} (unten) | Boxenvolumen: 149 l}
	\label{fig:4.2.3.2}
\end{figure}
...
\newpage
Eine weitere Messung mit Polyersterwatte in der Box wurde deshalb durchgeführt, weil beide Frequenzgänge bei ca. 300 Hz eine ähnliche Unregelmäßigkeit aufweisen.
...
\begin{figure} [H]
	...
	\caption{Subwoofer-Messung mit Polyesterwatte\\ \enquote{Renkforce} (oben) und \enquote{Visaton} (unten) | Boxenvolumen: 149 l}
	\label{fig:4.2.3.3}
\end{figure}
Beide Frequenzgänge wurden durch das Hinzufügen von Polyesterwatte etwas \enquote{glatter}, also weisen weniger Welligkeit auf.
Die Polyesterwatte kann z.B. stehende Wellen in der Box verhindern und verbessert so die Eigenschaften der gesamten Box.\\ \\	%Es wirkt wie eine Vergrößerung des Volumens - hat Wagn einmal gsagt
...
Um möglicherweise bessere Ergebnisse erzielen zu können, wurde das Volumen mittels Ton-Ziegelstein, Styropor oder Ytong-Ziegel verringert, oder durch Polyesterwatte vergrößert.\\
...
\begin{figure} [H]
	...
	\caption{Tiefton-Lautsprecher-Messung ohne Polyesterwatte\\ \enquote{TT1} (oben) und mit Polyesterwatte \enquote{TT1} (unten) | Boxenvolumen: 13,72l}
	\label{fig:4.2.4.1}
\end{figure}
...
Des Weiteren sollte er besser mit Polyesterwatte versehen werden.

\newpage
Als Referenz wird der Lautsprecher \enquote{TT2} gemessen. 
Ebenfalls einmal ohne und einmal mit Polyersterwatte im Gehäuse.
\begin{figure} [H]
	\centering
	...
	\caption{Tiefton-Lautsprecher-Messung ohne Polyersterwatte\\ \enquote{TT2} (oben) und mit Polyersterwatte \enquote{TT2} (unten) Boxenvolumen: 13,72 l}
	\label{fig:4.2.4.2}
\end{figure}
...
Wieder ist ersichtlich, dass mit Polyesterwatte die Welligkeit im Mittel und Tiefton-Bereich etwas verringert wird.
