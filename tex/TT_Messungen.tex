...
Um die Aufnahmen ansehnlicher zu machen wurde der Frequenzgang durch Nachbearbeitung ausgeschnitten, sodass im Gegensatz zur Abbildung \ref{fig:4.1.1.1} in den nachfolgenden Bildern (ab Abb. \ref{fig:4.2.3.2}) nur die zum Vergleichen relevanten Kurven dargestellt werden.
\begin{figure} [H]
	\centering
...
\newpage
\subsection*{Satelliten-Tieftöner} \label{4.2.4}
