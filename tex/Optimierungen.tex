...
Dafür wird die Messbox mit 149 l in ihrem Volumina vermindert um zu testen, ob zuvor genannte Verluste auftreten.
...
Gleich wie für die Subwoofer-Box gilt auch hier das Boxenvolumen weitestgehend zu vermindern, unter der Bedingung das Klangqualität und Schalldruckpegel nicht darunter leiden.
Hier wird die Tiefton-Lautsprecher-Box mit 13,72 l als Messobjekt verwendet.
Mit verschiedenen Volumina und mit oder ohne Wolle, wird das Tiefton-Lautsprecher-Chassi \enquote{TT1} gemessen.\\
...
Ein möglicher Grund für diesen Einbruch kann eine Resonanz in der Box, auf Grund der Seitenwandlänge, sein.
Diese Annahme kommt daher, dass die Seitenlänge der Box möglicherweise genau $\frac{Lamda}{2}$ für diese Frequenz bedeutet und dadurch die an der Rückwand reflektierte Welle sich mit der hin laufenden Welle auslöscht.
Es entsteht eine Resonanz mit der Box.
Es wird deshalb eine Schraubzwinge in mitten der Seitenlänge der Box montiert um diese mögliche Resonanz zu unterbinden.
...
\textbf{Schlussendlich erschien die Messungkurven \ref{fig:4.4.3.5} als beste Kurve.
