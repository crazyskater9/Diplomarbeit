...
\subsection{Aufschlüsselung - Macsek}
\begin{figure} [H]
	\centering
...
Es wurden 19mm Spanplatten verwendet.
\subsection{Subwooferbox}
Benötigte Platten:
\begin{itemize}
	...
	\item Schacht-Oben: 400 x 139 x 19 [mm]
...
Die Rückseite ist verkürzt um eine Ausnehmung und somit den Platz für den Elektronikschacht zu gewährleisten.
Dieser Schacht ist von Spanplatten umschlossen, sodass das Gehäuse auch ohne Elektronikschacht-Einschub luftdicht verschlossen ist.


\subsection{Satellitenbox}
Benötigte Platten:
\begin{itemize}
...
\end{itemize}
In der Vorderseite werden zwei runde Löcher vorgesehen um einen Hochton-Lautsprecher mit 7 cm Durchmesser und einen Tieftonlautsprecher mit 16 cm Durchmesser montieren zu können.

\newpage
\section{Datenblätter}\label{sec:8.2}
\subsection{TDA2030}\label{subsec:8.3.5}
\begin{figure} [H]	
	\centering
	\includegraphics[width=0.82\textwidth]{form/tda2030first.PNG}
\end{figure}
\includepdf[pagecommand={},pages={2-12}, noautoscale =true, scale = 0.77]{form/tda2030.pdf}
...
\section{Grundlegendes}\label{sec:8.1}
...
\subsection{Nicht invertierende Verstärker - OPV-Grundschaltung}\label{sec:8.5}
...
\subsubsection*{Asymmetrische Versorgung eines OPV's}\label{subsec:8.5.1}
