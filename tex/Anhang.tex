...
\begin{figure} [H]
	\centering
	\subfloat{\includegraphics[width=0.48\textwidth]{img/Fertigungsunterlagen/Elektronikschacht3D.png}}\quad
	\subfloat{\includegraphics[width=0.48\textwidth]{img/Fertigungsunterlagen/Elektronikschacht2D.png}}
...
\section{Ergänzende Informationen}\label{sec:8.1}
\begin{comment}
{\newpage
...
\newpage
\subsection{TDA2030-Leistungstransistor-Schaltung}\label{subsec:8.3.3}
