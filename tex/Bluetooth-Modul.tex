...
\end{figure}
Wie in Abbildung \ref{fig:5.3.4.1} dargestellt, ist der Audio-Ausgang auf den Pins 1-3.
...
Die Platine(Abb. \ref {fig:5.3.8.3.1}) für die Hauptplatine sollte möglichst kompakt sein und alle Eingänge oder Bedienelemente auf einer Seite (hier rechts) haben.
