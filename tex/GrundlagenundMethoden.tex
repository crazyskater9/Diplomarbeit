...
\begin{figure} [H]
	\centering	
	\includegraphics[width=1\textwidth]{img/Grundlagen/OPV-Verstaerker/OPV-VerstaerkerGrundschaltung.png}
	\caption{Nicht invertierender Verstärker - OPV-Grundschaltung}
	\label {fig:3.5.1}
