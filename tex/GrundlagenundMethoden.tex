...
Betrachtet man nur die dunkelblaue Kurve (in Abb. \ref{fig:3.2.2}) ist sofort ersichtlich, dass über 400 Hz der Pegel stark abnimmt.
...
Auch für die rote Kurve kann man dies bestimmen.
...
Dieses System, bestehend aus linker und rechter Satelliten-Box (Abb. \ref{fig:3.2.3}), eignet sich bereits für Stereo-Klang.
...
\begin{enumerate}
	\item Die Lautsprecher-Chassis sollen in Richtung des Zuhörers zeigen
	\item Die Hochton-Lautsprecher sollen sich auf Ohrenhöhe des Zuhörers befinden
	\item Die Lautsprecher-Boxen sollen optimalerweise, wie eingezeichnet, einen 30° Winkel zur Blickrichtung des Zuhörers aufweisen
\end{enumerate}
...
\begin{figure} [H]
	...
	\caption{Optimale Ausrichtung zum Zuhörer}
	\label{fig:3.2.4}
\end{figure}
...
Es ist üblich, dass in den Satelliten wieder zwei Lautsprecher-Chassis verbaut werden.
...
Das bedeutet, dass der Zuhörer inmitten dieses Systems rundum beschallt wird.
...
In unserem Projekt haben wir uns für ein 2.1-System entschieden, da sich dieses System am besten bewährt hat und für Musik ein Stereo-System mit Subwoofer völlig ausreicht.
Die zwei Satelliten sind mit je einem Hochton- und einem Tiefton-Lautsprecher ausgestattet und werden über Audio-Kabel mit der Hauptbox verbunden.
