...
\begin{figure} [H]
	...
	\label{fig:3.1.1}
\end{figure}
Ein wichtiger Teil des Projekts ist die Bluetooth-Hauptplatine (Abb. \ref{fig:3.1.1} links unten).
...
Der \enquote{Center}-Lautsprecher ist aus diesem Grund wichtig, da sich aus der Erfahrung heraus bewiesen hat, dass Sprache eines sich inmitten des Bildes befindenden Menschen, auch akustisch mittig zu lokalisieren sein sollte.\\ 
