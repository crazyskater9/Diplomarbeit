...
Für den Mono-Subwoofer wird eine eigene Schaltung entwickelt, die nicht nur die unerwünschten Signalanteile herausfiltert, sondern zusätzlich linken und rechten Kanal des Stereo-Signal zu einem Mono-Signal addiert.\\ \\
%\newpage ??
...
Das schlussendlich verstärkte und gefilterte Audiosignal wird an den Lautsprechern wiedergegeben.\\
...
Das Ziel für die Auswahl der Lautsprecher war es,  Lautsprecher-Chassis mit möglichst gutem Frequenzgang (großer verwendbarer Frequenzbereich im Zusammenhang mit geringer Welligkeit [Kap. \ref{sec:8.6}]) und hohem Wirkungsgrad zu finden.
...
Ein kleines Volumen ist nötig, da das fertige Lautsprecher-System auch für den Außenbereich verwendet werden, und daher leicht transportabel sein soll.
Diese Bedingungen fordern eine Optimierungsarbeit am Boxenvolumen.